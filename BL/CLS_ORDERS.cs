...
namespace Final_Project.BL
{
    class CLS_ORDERS
    {
        ...
        public void ADD_ORDER(int ID_ORDER, DateTime DATE_OTDER, int CUSTOMER_ID,
                string DESCRIPTION_ORDER, string SALESMAN)
        {
            ...
            param[1] = new SqlParameter("@DATE_OTDER", SqlDbType.DateTime);
            param[1].Value = DATE_OTDER;
        ...
        public DataTable GetOrderDetailsWeb1()
        
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable Dt = new DataTable();
            DataTable Dt1 = new DataTable();
            Dt = DAL.SelectData("GetOrderDetailsWeb1", null);
            DAL.Close();
            return Dt;
        }
        ...
        public void DeleteProductWeb(int ID)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.Open();
            SqlParameter[] param = new SqlParameter[1];
            ...
            param[0].Value = ID;
            DAL.ExecuteCommand("DeleteProductWeb", param);
            DAL.Close();
        }
